...
- React Native app shell through Expo;
...
- dependency-free Node tests for the readiness model and mobile class tokens;
...
- **Green:** the React Native app scaffold, NativeWind/Tailwind config, Redux
  slice, selectors, and readiness model made the tests pass.
