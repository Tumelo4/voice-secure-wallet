...
for root in bootstrap environments/demo environments/staging environments/production-reference; do
...
echo "Terraform AWS modules, bootstrap, demo, staging and production-reference validation passed"
